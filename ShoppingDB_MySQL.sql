...
insert into Account (`user_mail`, `password`, `account_role`, `user_name`, `user_address`, `user_phone`) 
VALUES (N'hungtran@gmail.comn', N'123', 1, N'Hưng Trần Nguyễn', N'52 Thái Thương, Hà Nội', N'0966751234')

insert into Account('user_mail','password','account_role','user_name')
values (N'kankuzo123@gmail.com',N'123',1,N'Minh Tuấn','','')

select * from Account

select * from Account
where user_mail = "kankuzo123@gmail.com" and password ="123"

select * from Products
where product_name like '%11%'
